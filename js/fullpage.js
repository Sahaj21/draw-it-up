  ...
  function initialise(containerSelector, options) {
    ...
    function onTab(e) {
      ...
      var focusableElements = $(
        focusableElementsString + ':not([tabindex="-1"])',
        focusableWrapper
      );
      ...
      if (activeElement) {
        if (
          closest(activeElement, SECTION_ACTIVE_SEL + "," + SLIDE_ACTIVE_SEL) ==
          null
        ) {
    ...
    function addSlidesNavigation(section, numSlides) {
      ...
      for (var i = 0; i < numSlides; i++) {
        appendTo(
          createElementFromHTML('<li><a href="#"><span></span></a></li>'),
          $("ul", nav)[0]
        );
      }
